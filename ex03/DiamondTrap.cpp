...
DiamondTrap::DiamondTrap(): ClapTrap("Unamed_clap_name"), FragTrap(ClapTrap::_name), ScavTrap(ClapTrap::_name), _name("Unamed") {
	std::cerr << "Default DiamondTrap constructor called" << std::endl;
